        ...
        <div className="Content">
          <div className="MaxWidth">
            ...
            <div className="Card FirstCard">
              ...
              <p>
                I made Quizlet, an educational software company serving millions
                of students and teachers worldwide. Quizlet, at its best, is
                transformative for students’ confidence. It gives them a system
                for learning that helps them come prepared to whatever class
                they’re taking, and thus raises their own expectations of what
                they can achieve.
              </p>
              <p>
                After many years growing Quizlet, I left to work on new
                bullshit. What that is yet isn’t exactly clear. But you’re gonna
                be dazzled by it.
              </p>
              <h3>My Story</h3>
              <p>
